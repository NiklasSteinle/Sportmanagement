...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  useEffect(() => {
    ...
    if (permissionsData === "Helfer" || permissionsData === "Admin") {
      menuGroupsFirst.push({
        name: "HELFER",
        menuItems: [
          {
        ...
        menuItems: [
          {
            ...
            route: "#",
            children: [
              { label: "Klassen hinzufügen", route: "/Admin/classes" },
              { label: "QR-Codes erstellen", route: "/Admin/qrcode/create" },
              {
                label: "QR-Codes erneut drucken",
                route: "/Admin/qrcode/print",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            route: "#",
            children: [
              { label: "Zeitplan", route: "/Admin/stations/timeplan" },
              { label: "Stationen hinzufügen", route: "/Admin/stations/add" },
            ],
          },
        ],
      });
